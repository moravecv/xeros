...
ggsave(filename = "maps_manuscript_001_1_3_5.pdf", device = "pdf", width = 150, units = "mm")

##### supporting info plot ####

geu <- geom_path(aes(x = long, y = lat, group = group), data = eu, size = 0.2)

dta5 <- dta3[yag %in% c(1, 3, 5),]
...
ggsave(filename = "maps1_supp_met_001.pdf", device = "pdf", width = 200, units = "mm")
...
ggsave(filename = "maps3_supp_met_001.pdf", device = "pdf", width = 200, units = "mm")
